...
```
right skew - use lof transform to normalize and visualize
log transformation on a skewed dataset is a common and effective form of normalization
...
This Figure shows the top 10 combinations of countries and type of plastic collected during cleanup events.
...
*(@ Sravan Condense this information into valuable insights. Describe based off of heat map)*
