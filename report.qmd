...
**LDPE** (Low-Density Polythylene) : Often found in plastic bags and packing films.

**PP** (Polypropylene): Used in bottles caps, food containers and straws.

**HDPE**

**PS** (Polystrene): Found in disposable cutlery and foam packing.

**PVC** (Polyvinyl Chloride): Less common, but used in pipes and some packings
