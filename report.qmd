...
```{r top_countries_chunk, eval=FALSE, echo=FALSE, message=FALSE, warning=FALSE}
...
kable(top_countries, caption = "Top Companies Contributing to Plastic Waste by Country (Top 10)")
#(verify whether this chunk is needed, change eval options if yes)
